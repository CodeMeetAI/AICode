...
if __name__ == "__main__":
    ...
    num_questions_per_dialogue = 3  # 每轮对话的问题数
    num_dialogues = 100  # 生成对话的数量
    dialogues = data_loader.generate_dialogues(num_questions_per_dialogue, num_dialogues)

    output_file_path = '/home/eidf018/eidf018/s2484588-epcc/MLP/LLMMemoryEval/datasets/data/natural_questions/nq_dialogues_llama2.json'  
